...
# demonstrates how to create and use a local library with propane
# Also features use of 'forwardable' to create a custom enumerable
class Spirograph < Propane::App
  ...
  def setup
    ...
    Processing::ArcBall.init(self) # use mouse wheel to zoom, drag to rotate
    new_particle
  end
